...
export const translations: Record<LanguageCode, Translations> = {
  en: {
    ...
    'auth.signupSuccessMsg': 'Account created successfully! Please sign in with your email and password.',
  ...
  bn: {
    ...
    'auth.signupSuccessMsg': 'অ্যাকাউন্ট সফলভাবে তৈরি হয়েছে! অনুগ্রহ করে লগ ইন করুন।',
